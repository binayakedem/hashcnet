    ...
    <div className='mx-4 md:mx-12 lg:mx-24 text-[#e1e1e1]   '>
        <div className="grid grid-cols-1 md:grid-cols-2 pt-4">
            ...
            <h1 className={theme==='light'?'font-semibold text-xl md:font-bold md:text-2xl  text-gray-900 font-play ':'font-semibold text-xl md:font-bold md:text-2xl font-play text-[#ffe699] '}>Who we are..(About Us)</h1>
                <img data-aos='fade-in' data-aos-duration='1000' src={about}alt=" about page" />
            </div>
            <div className= {theme==='light'?'flex flex-col gap-4 md:gap-8  p-8 rounded-lg bg-gray-50 text-gray-800':'flex flex-col gap-4  md:gap-8 p-8 rounded-lg '}>
                
                <p data-aos='zoom-in-up' data-aos-duration='1500'> HASH CNET PVT LTD is a leading technology company in Nepal, offering 
...
<p data-aos='zoom-in-up' data-aos-duration='1500'>The company was established in 2018 by experienced team of tech 
